            ...
            <ul>
                <li>
                    ...
                    <div className="project-description">
                        ...
                        <p>
                            ...
                            frontend, and vanilla CSS for styling.
                        </p>
                        <p>
                            Implemented features such as user authentication
                            using Bcrypt and a commenting system to enhance user
                            engagement.
                        </p>
                        <p>
                            Utilized responses from the server to determine the
                            user's location on the webpage and ensure a smooth
                ...
                <li>
                    ...
                    <div className="project-description">
                        ...
                        <p>
                            Utilized Ruby and Sinatra to create a backend that
                            stores objects and manages user authentication.
                        </p>
                        <p>
                            Implemented a join table between users and images to
                            allow for easy management of user-generated content.
                        </p>
                        <p>
                            Used Sinatra to handle requests from the frontend
                            and ensure seamless communication between the client
                            and server.
                        </p>
                    </div>
                </li>
                <li>
                    ...
                    <div className="project-description">
                        ...
                        <p>
                            Implemented a frontend using Styled-Components for
                            styling, React-Router-Dom for client-side routing,
                            and Framer-Motion for animation.
                        </p>
                        <p>
                            Developed an application that allows users to play
                            multiple games with a smooth and interactive
                            interface.
                        </p>
                        <p>
                            Utilized JSON to store and retrieve game data and
